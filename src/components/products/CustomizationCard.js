    ...
    <div className="relative flex flex-col items-center justify-center w-full p-4 min-h-[100px] mx-1 border-[1px] border-gray-600 rounded-md hover:bg-gray-200 mb-2">
      <div className="flex flex-col items-begin justify-center w-full relative">
        <p className="text-sm font-bold mb-2 pr-2">
          <input type="text" value={customization.name} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2" placeholder="Option name" required onChange={
            (e) => {
        ...
        Object.keys(customization.options).sort().map((optionId) => (
          <div key={optionId} className="flex flex-col items-begin justify-center w-full relative">
            <div className="flex gap-1 mb-1">
              <div className="grow">
                <input type="text" value={customization.options[optionId].name} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2" placeholder="Option name" required
                  onChange={
                    (e) => {
                      let customizationCopy = { ...customization };
              ...
              <div>
                <input type="number" value={customization.options[optionId].price} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2" placeholder="Price" required
                  onChange={
                    (e) => {
                      let customizationCopy = { ...customization };
                      customizationCopy.options[optionId].price = e.target.value;
                      updateCustomization(id, customizationCopy);
                    }
                  }
                />
