...
const Sidebar = ({ lng, sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-gray-800 duration-300 ease-linear dark:bg-gray-800 lg:static lg:translate-x-0 ${
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <a
                  href={`/${lng}/dashboard/stores`}
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-gray-400 duration-300 ease-in-out hover:bg-gray-900 dark:hover:bg-meta-4 ${
                    pathname.startsWith(`/${lng}/dashboard/stores`) &&
                    "bg-gray-900 dark:bg-meta-4"
                  }`}
                >
                  <svg
              ...
              <li>
                <a
                  href={`/${lng}/dashboard/products`}
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-gray-400 duration-300 ease-in-out hover:bg-gray-900 dark:hover:bg-meta-4 ${
                    pathname.startsWith(`/${lng}/dashboard/products`) &&
                    "bg-gray-900 dark:bg-meta-4"
                  }`}
                >
                  <svg
