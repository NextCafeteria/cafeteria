...
import userSeven from "@public/dashboard/images/user/user-07.png";
import userEight from "@public/dashboard/images/user/user-08.png";
import userNine from "@public/dashboard/images/user/user-09.png";
import userTen from "@public/dashboard/images/user/user-10.png";
...
const TaskHeader = () => {
  ...
  return (
    <div className="flex flex-col gap-y-4 rounded-sm border border-stroke bg-white p-3 shadow-default dark:border-strokedark dark:bg-gray-800 sm:flex-row sm:items-center sm:justify-between">
      <div>
