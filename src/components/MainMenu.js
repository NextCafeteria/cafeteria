  ...
  return (
    <>
      <div className="flex justify-evenly w-full fixed bottom-0 md:left-0 md:h-full md:w-auto md:flex-col h-[90px] border-t-[1px] md:border-t-0 md:border-r-[1px] border-gray-600 p-2 bg-[#ffbd2e]">
        <div
          className={
            "menu-home flex flex-col items-center p-2 clickable" +
        ...
        <div
          className={
            "menu-orders flex flex-col items-center p-2 clickable" +
        ...
        >
          ...
          >
            <path
              ...
              fill={currentPath === `/${lng}/user` ? activeTabColor : "#333333"}
            />
          </svg>
        ...
        {session?.data?.user?.isAdmin && (
          ...
          >
            ...
            <span
              className="flex justify-center text-sm md:text-xl mt-2"
              style={{
                color: currentPath.startsWith(`/${lng}/stores`)
                  ? activeTabColor
                  : "#333333",
              }}
            >
