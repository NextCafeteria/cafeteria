...
export default function PickOptions({ searchParams }) {
        ...
        <div className="flex flex-col items-center justify-center w-full p-4 min-h-[100px] my-1 mx-1 rounded-md">
                  ...
                  <div className="flex flex-col items-center justify-center w-full mt-2">
                    {customization.options.map((option, index) => (
                      <div key={index} className="w-full p-2 border-b-[1px] ">
                        <input type="radio" id={option.name} name={customization.name} value={option.name} checked={
                        ...
                        <label className="pl-2 w-100" htmlFor={option.name}>{option.name} (${option.price})</label>
                      </div>
                    ))}
                  </div>
                </div>
          ...
          <div className="flex flex-col items-begin justify-center w-full mt-4">
            ...
            <div className="flex flex-row items-center justify-center w-full mt-2">
              ...
              <input type="text" className="w-20 px-2 text-center font-bold" value={quantity} onChange={(e) => {
